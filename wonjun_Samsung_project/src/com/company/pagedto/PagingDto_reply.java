...
public class PagingDto_reply {
	...
	///생성자
	public PagingDto_reply() {super();	}
	public PagingDto_reply(int pageTotal, int onepageLimit, int pageAll, int pstartno, int bottomList, int bottom_current,
			int bottom_start, int bottom_end, ArrayList<ReplyDto> list) {
		this();
	...
	public ArrayList<ReplyDto> getList() { return list; }
	public void setList(ArrayList<ReplyDto> list) { this.list = list; }
	//toString
	@Override
	public String toString() {
		return "PagingDto_reply [pageTotal=" + pageTotal + ", onepageLimit=" + onepageLimit + ", pageAll=" + pageAll
