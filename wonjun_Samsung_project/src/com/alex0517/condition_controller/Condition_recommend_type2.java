...
public class Condition_recommend_type2 implements BAction {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("type2 : " +type_2);
		request.setAttribute("dto_type2", dao.type2_res1(dto));
		//System.out.println("5.type2선택시 no확인 : "+request.getAttribute("dto_type2"));
		//request.getRequestDispatcher("/card_search_condition/result.jsp");
		////
		Gson gson = new Gson();
		JsonArray array = new JsonArray();
		ArrayList<KeywordDto> list = dao.type2_res1(dto);
