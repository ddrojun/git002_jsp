...
public class Condition_recommend_company implements BAction {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("dto_company", dao.company_res1(dto));
		//System.out.println("3.카드사선택시 no확인 : "+request.getAttribute("dto_company"));
	/////////////////////////////////////
		Gson gson = new Gson();
		JsonArray array = new JsonArray();
		ArrayList<KeywordDto> list = dao.company_res1(dto);
