...
public class Condition_recommend_benefit implements BAction {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dto.setPhone(phone);
		///////////////////////////////////////////////
		String mart_1 = request.getParameter("mart_condition");
		String mart = "%"+mart_1+"%";		
		dto.setMart(mart);
		///////////////////////////////////////////////	
		...
		ArrayList<KeywordDto> list = dao.benefit_res1(dto, dto1);
