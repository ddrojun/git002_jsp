...
<div class="container">
	...
	<!--		<input type="button" id="result" name="result" class="btn btn-default result_condition" value="추천결과"    />		 -->
				<a href="<%=request.getContextPath()%>/start.customer" class="btn btn-dafault" style="color:white; background:#ff6e61;" >처음으로</a>  
				<a href="<%=request.getContextPath()%>/list.condition" class="btn btn-dafault" style="color:white; background:#ff6e61;" >초기화</a> 
			</div> 				
			</div>
		<div class="col-sm-3">
			<h3>검색 결과 </h3>
